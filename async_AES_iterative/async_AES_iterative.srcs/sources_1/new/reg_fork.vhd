...
signal data_reg1 : std_logic_vector(DATA_WIDTH-1 downto 0);
...
begin
  inA_token <= inA_req xor phase_a;
  outB_bubble <= phase_b xnor outB_ack;
  outC_bubble <= phase_c xnor outC_ack;
  -------------------------------------------------------

  click <= inA_token and outB_bubble and outC_bubble;
